...
def register(payload: UserCreate, db: Session = Depends(get_db)) -> User:
    ...
    try:
        ...
        # The constraint names are auto-generated by SQLAlchemy, but we can check
        # the exception origin and the table to be more specific.
        if "users_username_key" in str(exc.orig) or "users_email_key" in str(exc.orig):
